...
const Waitlist = () => {
  return (
    <div className='flex text-center w-2/4 m-auto justify-center items-center flex-col'>
        ...
        <input className='wait-input p-4 text-[#707070] p-4'  placeholder='First Name..' />

        <input className='text-gray-800 text-[#707070] p-4 wait-input outline-none'  placeholder='Last Name...' />
